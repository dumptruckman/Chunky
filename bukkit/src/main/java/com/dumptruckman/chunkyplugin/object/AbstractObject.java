package com.dumptruckman.chunkyplugin.object;
 ...
 */
public abstract class AbstractObject implements Persistable {
    ...
    private HashMap<String, HashSet<AbstractObject>> ownables = new HashMap<String, HashSet<AbstractObject>>();
