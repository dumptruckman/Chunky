...
package com.dumptruckman.chunkyplugin.test;

import com.dumptruckman.chunkyplugin.ChunkyPlugin;
import com.dumptruckman.minecraft.config.BaseConfig;
import com.dumptruckman.chunkyplugin.test.utils.TestInstanceCreator;
...
public class TestBasics {
    ...
    public void testEnableDebugMode() {
        ...
        when(mockCommand.getName()).thenReturn("chunky");
