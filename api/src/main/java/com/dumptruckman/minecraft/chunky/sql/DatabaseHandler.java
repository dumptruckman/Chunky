 ...
 * @author PatPeter
 */
package com.dumptruckman.minecraft.chunky.sql;
...
public abstract class DatabaseHandler {
    ...
    public DatabaseHandler(String dp) {
    ...
    protected void writeInfo(String toWrite) {
        if (toWrite != null) {
            Logging.info(this.DATABASE_PREFIX + toWrite);
        }
    }
    ...
    protected void writeError(String toWrite, boolean severe) {
        if (toWrite != null && !toWrite.contains("Duplicate")) {
            if (severe) {
                Logging.severe(this.DATABASE_PREFIX + toWrite);
            } else {
                Logging.warning(this.DATABASE_PREFIX + toWrite);
            }
        }
    }
